...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt RustDesk niet langer UDP 56116, maar TCP 56116."),
